...
Создайте новую ветку для вашей фичи (git checkout -b feature/CoolFeature).

Внесите изменения и сделайте коммит (git commit -m 'Добавлена новая крутая функция').

Отправьте изменения в свой форк (git push origin feature/CoolFeature).

Откройте Pull Request в этом репозитории.

Если вы нашли баг или у вас есть предложение, смело создавайте новую тему в разделе Issues.
